...
- [深度学习工程模板，简化加载数据、构建网络、训练模型和预测样本的流程。](https://github.com/SpikeKing/DL-Project-Template)
- [深度学习入门教程&&优秀文章&&Deep Learning Tutorial:图文并茂！！！](https://github.com/Mikoto10032/DeepLearning)
...
## 并行计算
- [并行计算资源](https://github.com/tsung-wei-huang/awesome-parallel-computing)
...
- [深度度量学习的PyTorch库](https://github.com/KevinMusgrave/pytorch-metric-learning)
- [Awesome-pytorch-list中文版，PyTorch学习资源大合集](https://github.com/xavier-zy/Awesome-pytorch-list-CNVersion)
...
# 比赛竞赛
- [机器学习、深度学习相关的比赛，竞赛和会议比赛](https://github.com/skrish13/ml-contests-conf)
- [Kaggle-2019-open-images实例分割比赛实现方案-使用Mask-RCNN作为benchmark](https://github.com/yu4u/kaggle-open-images-2019-instance-segmentation)
- [Kaggle RSNAd 第二名解决方案](https://github.com/morganmcg1/kaggle_rsna_2nd_place_solution)
- [Brain tumor segmentation for MICCAI 2017 BraTS challenge](https://github.com/taigw/brats17)


# 求职

## 简历模板
- [简历模板](https://github.com/ice1000/resume)
...
- [计算机视觉算法工程师实习生面试总结（微软、阿里、商汤、海康、华为、平安offer）](https://github.com/espectre/Algorithms_Engineer_Interview)
- [2020年的算法实习岗位/校招公司信息表，部分包括内推码，和常见深度学习算法岗面试题及答案，暑期计算机视觉实习面经和总结](https://github.com/HarleysZhang/2019_algorithm_intern_information)
- [2020秋招 计算机视觉算法岗面经整理——包含实习和校招等 内推整理](https://github.com/DWCTOD/interview)
- [国内公司人工智能方向（含机器学习、深度学习、计算机视觉和自然语言处理）岗位的招聘信息（含全职、实习和校招）](https://github.com/amusi/AI-Job-Recommend)
